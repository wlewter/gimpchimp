...
exports.getFeatureList = function(req, res) {
    return Feature.find(function (err, features) {
        if (!err) {
 ...
 * Add a feature req
 */
exports.addFeatureReq = function(req, res) {
...
exports.realmRanks = function(req, res) {
  ...
  return fs.readFile(rrFile, function(err, rrData) {
    ...
    return res.send(200, JSON.parse(rrData));
  });
...
function search(searchStr, cluster) {
  var url = 'http://api.camelotherald.com/character/search?name=' + searchStr + '&cluster=' + cluster;
...
function getCharacterData(id) {
  var url = 'http://api.camelotherald.com/character/info/';
  var response = request({
    uri: url + id,
    method: 'GET'
  });
